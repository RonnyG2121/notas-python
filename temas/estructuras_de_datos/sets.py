...
# Definiendo un set
planetas_set = {"Marte", "júpiter", "Venus"}

# añadiendo un elemento al set. hay que tener en cuenta que este elemento añadido no se puede modificar
planetas_set.add("Tierra")
planetas_set.add("Sol")

# eliminando un elemento del set
planetas_set.remove("Sol")
print(planetas_set)
