...
#print(area_triangulo(50, 100))


# Calculando el área del cubo

alCubo = lambda numero: math.pow(numero, 3)

#print(alCubo(13))

# misma función pero con operadores

alCubo2 = lambda numero: numero ** 3
print(alCubo2(13))
